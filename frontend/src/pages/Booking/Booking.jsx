...
import {
    ...
    FaRegHospital, FaRegImage, FaTimesCircle, FaInfoCircle, FaPhoneAlt, FaSearch
} from 'react-icons/fa';
...
const Booking = () => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            formData.append('date', `${selectedDate}T${selectedTime}:00`);
            ...
            const response = await api.post('/appointments/register', formData, {
                    ...
                    <div className="booking-left-column">
                        ...
                        {step === 3 && (
                            <div className="patient-form-new animate-fade-in">
                                ...
                                <div className="form-group-new">
                                    <label>Đính kèm ảnh (Sổ khám, đơn thuốc cũ, ảnh triệu chứng...)</label>
                                    <div className="file-upload-container">
                                        <label className="file-upload-label">
                                            <FaRegImage /> Chọn ảnh hoặc kéo thả vào đây (Tối đa 5 ảnh)
                                ...
                                <div className="info-group-new">
                                    ...
                                    {previews.length > 0 && (
                                        <div className="summary-item-new">
                                            ...
                                            <div className="confirm-previews">
                                                {previews.map((url, idx) => (
                                                    <img key={idx} src={url} alt="confirm-preview" />
                                                ))}
                                            </div>
                                        </div>
                                    )}
